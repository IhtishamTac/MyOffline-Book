...
<body>
    @include('layout.nav')
    <div class="container mt-5 wraps" style="">
        ...
        <div class="d-flex justify-content-between">
            ...
            <form action="{{ route('caribuku') }}" method="GET">
                <div class="d-flex gap-2">
                    <input type="search" name="cariBuku" class="form-control" oninput="this.form.submit()"
            ...
            <div class="row">
                ...
                @foreach ($books as $book)
                    ...
                    <div class="col-4 p-3 mt-3 mb-auto" style="background-color: rgb(235, 235, 235);">
                        ...
                        <p style="white-space: nowrap; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            {{ $book->deskripsi }}</p>
                        <form action="{{ route('post-keranjang', $book->id) }}" method="POST">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <h5 style="margin-top: 4px;">Rp. {{ number_format($book->harga_buku, 2, ',', '.') }}
                                </h5>
                            </div>
                        </form>
                    </div>
