            ...
            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('post-add-book.admin') }}" enctype="multipart/form-data"  method="POST">
                        ...
                        <div class="mt-3">
                            <textarea name="deskripsi" style="resize: none;" class="form-control" cols="30" rows="3" placeholder="Deskripsi singkat..." required></textarea>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="number" name="stok" min="1" class="form-control" value="1" required>
                        </div>
                        <div class="mt-3">
